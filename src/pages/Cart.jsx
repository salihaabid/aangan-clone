...
//       <h2 className='text-2xl font-bold text-[#2a4125] mb-6'>Your cart</h2>
...
//             {/* Qty controls (UI only) */}
//             <div className='flex items-center space-x-2'>
//               <button className='px-2 border rounded cursor-pointer'>−</button>
...
//         <p className='text-lg font-medium'>Estimated total: Rs.0.00</p>
//         <button className='bg-[#2a4125] text-white px-6 py-3 rounded-full shadow hover:bg-[#3a5135] transition'>
//           Check out
//         </button>
//       </div>
//     </div>
