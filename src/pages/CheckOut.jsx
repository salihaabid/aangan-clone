...
//                focus:outline-none focus:ring-2 focus:ring-[#77846a]
//                text-gray-700 placeholder-[#77846a]'
//             />
//             <button
//               onClick={handleApplyCoupon}
//               className='bg-[#2a4125] text-white px-6 rounded-r-xl
//                hover:bg-[#1e301b] transition-colors duration-200'
//             >
//               Apply
//             </button>
//           </div>
...
export default function CheckoutPage() {
  ...
  const handleCompleteOrder = () => {
    ...
    existingOrders = [...newOrder, ...existingOrders]; // prepend
